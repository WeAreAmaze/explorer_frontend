    ...
    >
      <Box flexGrow="1" mb={{ base: 8, lg: 0 }}>
        ...
        <Box mt={{ base: 5, lg: '24px' }}>
          <Link fontSize="xs" href="https://mainnet.amazechain.com/">
            AmazeToken Mainnet
          </Link>
          &nbsp; &nbsp;
          <Link fontSize="xs" href="https://testnet.amazechain.com/">
            AmazeToken Testnet
          </Link>
        </Box>

        <Text mt={ 3 } maxW={{ base: 'unset', lg: '470px' }} fontSize="xs">
          AmazeToken is a tool for inspecting and analyzing EVM based
          blockchains. Blockchain explorer for Amazetoken Networks.
        </Text>
